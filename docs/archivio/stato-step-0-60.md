# Archivio — gli Step 0-60, com'erano raccontati in STATO.md

> Questo è il testo che `STATO.md` ha accumulato fra il 1° agosto e il 13 settembre 2026, spostato
> qui **verbatim** il 13 settembre. Non è stato riscritto né corretto: è la cronaca com'era, e per
> questo alcune frasi sono superate dai fatti — vanno lette con la data che portano addosso.
>
> Dove siamo **adesso** sta in [STATO.md](../STATO.md); l'elenco degli step in
> [registro.md](../registro.md); com'è andata giorno per giorno in [devlog.md](../devlog.md).
