...
**Sessantuno step, dallo 0 al 60**, elencati uno per riga in [registro.md](registro.md). Sei piani
...
**1359 test verdi** (665 core + 640 app + 54 relay), con `typecheck`, `lint` e `format:check`
puliti.
